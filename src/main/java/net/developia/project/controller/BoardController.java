...
public class BoardController {
	...
	public ResponseEntity<List<AttachFileDTO>> uploadAjaxPost(MultipartFile[] uploadFile) throws Exception{
		...
		String uploadFolder = "/Users/turtlegim/upload/";
	...
	public ResponseEntity<byte[]> getFile(String fileName){
		...
		File file = new File("/Users/turtlegim/upload/"+fileName);
		log.info("file: "+file);
	...
	public ResponseEntity<Resource> downloadFile(@RequestHeader("User-Agent") String userAgent, String fileName){
		Resource resource = new FileSystemResource("/Users/turtlegim/upload/"+fileName);
	...
	public ResponseEntity<String> deleteFile(String fileName, String type){
		...
		try {
			file = new File("/Users/turtlegim/upload/"+URLDecoder.decode(fileName, "UTF-8"));
			file.delete();
	...
	@GetMapping("/search")
	public String searchList(@PathVariable long pg, @PathVariable long new_no, String searchType, String searchword, Model model) throws Exception {
			try {
				long recordCount = boardService.searchBoardCount(new_no, searchType, searchword);
				long pageCount = recordCount / pageSize;
				if (recordCount % pageSize != 0) pageCount++;
				...
				long endPage = startPage + blockSize - 1;
				if(endPage > pageCount) endPage = pageCount;
				List<BoardDTO> list = boardService.searchBoardListPage(pg,new_no, searchType, searchword);
				...
				model.addAttribute("msg", "검색결과 출력 에러");
				model.addAttribute("url", "index");
				return "result";
			}
		}
