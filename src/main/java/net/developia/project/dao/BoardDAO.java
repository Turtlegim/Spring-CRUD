...
public interface BoardDAO {
	...
	long searchBoardCount(@Param("new_no") long new_no, @Param("searchType") String searchType, @Param("searchword") String searchword) throws Exception;

	List<BoardDTO> searchBoardListPage(@Param("startNum") long startNum, @Param("endNum") long endNum, @Param("new_no")long new_no, @Param("searchType") String searchType, @Param("searchword") String searchword);
