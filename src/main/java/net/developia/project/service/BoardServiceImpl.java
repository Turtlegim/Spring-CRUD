...
public class BoardServiceImpl implements BoardService {
	...
	@Override
	public List<BoardDTO> searchBoardListPage(long pg, long new_no, String searchType, String searchword) throws Exception {
		long startNum = (pg - 1) * pageSize + 1;
		long endNum   = pg * pageSize;
	
		return boardDAO.searchBoardListPage(startNum, endNum, new_no, searchType, searchword);
	}

	@Override
	public long searchBoardCount(long new_no, String searchType, String searchword) throws Exception {
		return boardDAO.searchBoardCount(new_no, searchType, searchword);
	}
